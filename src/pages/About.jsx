    ...
    <div className="px-4 md:px-10">
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-700">
          <p>
            Welcome to **Prescripto**, your trusted healthcare platform. Our mission is to connect you with **top-rated doctors** and **seamless online appointment scheduling**, ensuring easy access to quality healthcare.
          </p>
          <p>
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-20">
        {/* Efficiency */}
        <div className="border px-10 md:px-16 py-8 flex flex-col gap-4 text-gray-600 text-sm hover:bg-blue-500 hover:text-white transition-all duration-300 cursor-pointer rounded-lg shadow-md">
